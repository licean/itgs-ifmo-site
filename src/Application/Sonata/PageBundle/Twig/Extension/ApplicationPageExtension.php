 ...
 * User: IShebarshov
 *
 * Replace SonataPage Twig Extension. Cause: This twig extension contain private field without getters
 */
...
class ApplicationPageExtension extends \Twig_Extension
{
	/**
